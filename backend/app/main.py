...
from app.api.exam_timetable import router as exam_timetable_router
...
app.include_router(notifications_router, prefix=f"{settings.API_V1_STR}/notifications", tags=["Universal Notification Center"])
